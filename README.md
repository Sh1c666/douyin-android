...
一个**只读**的抖音 Android 客户端：刷推荐流 / 搜视频 / 看评论 / 看主页，**无任何互动**。模仿 [PiliPlus](https://github.com/bggRGjQaUbCoE/PiliPlus) 的思路——**App 直接调抖音官方接口，签名在端上做，不依赖任何本地后端**。装上 APK、粘一次 cookie 就能用。
