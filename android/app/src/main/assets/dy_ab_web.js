/* AUTO-GENERATED from backend/sign/dy_ab.js by tools/make_dy_ab_web.py.
   Standalone on-device a_bogus signer for the WebView. jsrsasign stripped
   (only needed by bd-ticket-guard methods we don't use). Do not edit by hand. */
